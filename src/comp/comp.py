...
starting_letters = ['C', 'D', 'E', 'F', 'G']
c = [i.name for i in humans if (i.name[0] in starting_letters)]
print(c)
...
# e = [f'{i.name}-{i.age}' for i in humans] <--- Easier method
...
g = [f"<Human: {i.name.upper()}, {i.age + 5}>" for i in humans]
print(g)
